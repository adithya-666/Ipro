  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        <img id="dashboard-logo" src="{{ asset('assets/img/logo-2.png') }}" alt="">
        <span class="d-none d-lg-block logo-name">indohadetama</span>
      </a>
          ...
          @auth
            <li>
              <form action="{{ '/logout' }}" method="post" id="logout">
                @csrf
              <button type="submit" class="dropdown-item d-flex align-items-center logout" >
...
<!-- Jquery -->
 ...
 <!-- Trix -->
 <script src="{{ asset('assets/js/scripts/trix.js') }}"></script>

 <!-- Sweet Alert 2 -->
 <script src="{{ asset('assets/js/scripts/sweetalert2.min.js') }}"></script>

 <!-- Moment.js -->
 <script src="{{ asset('assets/js/scripts/moment.js') }}"></script>
